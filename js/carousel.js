export class Carousel {
    ...
    constructor (objectCategory, options = {}) {
      ...
      // modification du DOM
      this.carousel = this.object.category // let root grafikart
      this.category.setAttribute('tabindex', '0',)
      this.carouselContainer = this.object.categoryContainer // let container grafikart
